...
There are many influential benchmarks in the field of 3D reconstruction all of them serving a different purpose. The Middlebury dataset \cite{conf/dagm/ScharsteinHKKNWW14} has been the foundational work in creating a structured framework for evaulating two-view stereo algorithm.
- DTU MVS dataset \cite{jensen2014large}
    - for robotics
    - no leaderboard to find MVS algorithms and their performance
- ETH3D \cite{schoeps2017cvpr}
...
- Tanks and Temples \cite{Knapitsch2017}
